<script lang="ts">
	...
	const seo = {
		title: 'Split Places',
		description: 'Discover beautiful places in Split and surrounding areas',
		keywords: 'split, croatia, places, visit, travel',
		ogTitle: 'Split Places',
		ogDescription: 'Discover beautiful places in Split and surrounding areas',
		ogImage: '',
		ogUrl: '',
		ogType: 'article',
		ogLocale: 'en_US',
