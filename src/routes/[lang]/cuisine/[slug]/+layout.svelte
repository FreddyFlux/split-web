<script lang="ts">
	...
	const seo = {
		title: 'Split Cuisine',
		description: 'Discover unique cuisine in Split and surrounding areas',
		keywords: 'split, croatia, food, cuisine, gastronomy, culinary',
		ogTitle: 'Split Cuisine',
		ogDescription: 'Discover unique cuisine in Split and surrounding areas',
		ogImage: '',
		ogUrl: '',
		ogType: 'article',
		ogLocale: 'en_US',
